...
public class Store {
    public void storeProd(String name,int quantity,int price,double cost,ArrayList<Products> list){
        File file,file1;
         String path="C:\\Abdullah\\university\\5\\ACP\\point-of-sale-java\\src\\sale1.txt";
         String path2="C:\\Abdullah\\university\\5\\ACP\\point-of-sale-java\\src\\sales.txt";
        file=new File(path);
    ...
    public void addStart(ArrayList<Products>prods){
        ...
        int count=0;
        String path="C:\\Abdullah\\university\\5\\ACP\\point-of-sale-java\\src\\sales.txt";
